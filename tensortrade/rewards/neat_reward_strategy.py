...
class NeatRewardStrategy(RewardStrategy, metaclass=ABCMeta):
    ...
    def get_reward(self, current_step: int, trade: Trade) -> float:
        ...
        if not trade.valid:
            reward = -1
            # print("reward: Trade is not valid : {}".format(real-trade.to_dict))
        ...
        # if reward is 0:
        #     print("0 reward", current_step, reward, self.exchange.balance, self.exchange.net_worth, real-trade.transact_amount, real-trade.transact_price, real-trade._trade_type)
